...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Shukra',
    description: 'Replay this Agent conversation on Shukra',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Shukra';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Shukra';
